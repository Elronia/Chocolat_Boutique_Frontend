      ...
      <div id="shipping-container">
        <div>
          ...
          <div className="emphasized">
            ...
            <p>
                <b>Weekends</b>
                <p>We do not ship packages over weekends to avoid products being stored in a non-climate controlled shipping facility. We do not offer Saturday deliveries, unless prior arrangements are made by contacting our team at support@chocolatdeboutique.com.</p>
                <p>Orders placed after noon on Thursdays, will ship the following Monday. We do not deliver on Sundays or Mondays.</p>
                <p>We ship using UPS. Once the package has left our facility, Boutique de Chocolat cannot assume responsibility for any shipping delays/problems due solely to the shipping carrier. In order to facilitate delivery, you may add additional information such as an apartment, suite, or floor number to your selected delivery address.</p>
            </p>
            <p>
                ...
                <p>UPS 2nd Day Air - $12.00</p>
                <p>UPS Next Day Air - $20.00</p>
                ...
                <p>Please note that due to fluctuating temperatures, Boutique de Chocolat cannot always guarantee shipping options other than Priority Overnight.</p>
            </p>
            <p>
...
If the recipient is unavailable to receive the delivery, your order will be returned to Boutique de Chocolat and our customer service team will contact you. Your delivery fee is nonrefundable and will not be applied to any additional delivery services. </p>
                <p>Orders are available for pickup, Monday through Friday - 12pm to 5pm. Due to the freshness of our products, any changes to the date of pickup, must be made before 6pm the previous day. Boutique de Chocolat is not responsible for orders that are unclaimed after 24 hours and no refunds will be issued.</p>
            </p>
            <p>
                <b>Holiday Deliveries</b>
                <p>Deliveries during any holiday are based on UPS business hours.</p>
                <p>If you have any questions about holiday deliveries, please contact our team at support@chocolatdeboutique.com.</p>
            </p>
            <p>
            ...
            <p>
                ...
                <p>We do not ship online orders internationally, but are happy to speak with you about overseas destinations. Please contact our team at support@chocolatdeboutique.com.</p>
            </p>
          </div> 
        </div>
      </div>
